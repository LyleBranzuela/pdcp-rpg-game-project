...
public class Stage_4 extends Stage
{
    ...
    ArrayList<String> easyParry = new ArrayList();
    ArrayList<String> mediumParry = new ArrayList();
    ArrayList<String> hardParry = new ArrayList();
    ...
    public String genParry(int parrySeq)
    {
        ...
        {
            case 1: 
                this.currentMove = easyParry.get(x);
                break;
            case 2:
                this.currentMove = mediumParry.get(x);
                break;
            case 3:
                this.currentMove = hardParry.get(x);
                break;
            default:
                break;
        }
    ...
    public boolean checkParry(String user)
    {
        switch(this.parryDiff)
        {
            case 1:
                this.isCorrect = user.equalsIgnoreCase(easyParry.get(this.x + 3));
                break;
            case 2:
                this.isCorrect = user.equalsIgnoreCase(mediumParry.get(this.x + 3));
                break;
            case 3:
                this.isCorrect = user.equalsIgnoreCase(hardParry.get(this.x + 3));
                break;
            default: 
    ...
    public void initiateStage(Player player)
    {
        ...
        {   System.out.println("");
            ...
            System.out.println("Parry the attack: ");
            ...
            do {
                    ...
                    {
                        System.out.println("Game over! You failed to counter the attack.");
                        player.setHealth(0);
                        break;
                    }
                    else
                        ...
                        switch(parrySuccess)
                        {
                            ...
                            case 6:
                            case 9:                    
                                System.out.println("You found a weak spot, strike now (Press 1)!");
